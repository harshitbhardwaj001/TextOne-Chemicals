...
const Vision = () => {
  return (
    <div className="flex gap-10 absolute top-[100%] bg-[rgba(47,112,176,0.05)] w-full py-[7rem] justify-center items-center">
      <div>
        <img src="/About2.png" alt="vision" className="w-[750px]" />
      </div>
